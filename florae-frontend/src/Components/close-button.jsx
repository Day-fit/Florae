...
export default function CloseButton({ onClick, buttonText = "Cancel" }) {
  return (
    <Button
...
export const baseInputClass = 'block w-full border rounded-lg px-4 py-2 focus:outline-none  transition';
