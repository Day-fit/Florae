...
export default function Footer() {
  ...
  return (
    <footer className="flex flex-col md:flex-row border-b-stone-200 border-b-2 w-full">
      ...
      <div className="flex flex-col md:flex-row items-left md:items-center md:justify-around w-full mt-9 md:mr-30 px-10 md:mb-25">
        {footerData.map((item, index) => (
          <div className="mb-6 md:mb-0" key={index}>
            <h3 className="font-bold text-green-700 mb-3 text-center md:text-left break-words px-2">
              {item.name}
            </h3>
            {item.subpoints && (
